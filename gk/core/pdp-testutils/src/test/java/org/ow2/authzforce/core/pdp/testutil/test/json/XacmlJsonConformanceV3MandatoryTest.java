 ...
 * @see XacmlJsonTest
 */
public class XacmlJsonConformanceV3MandatoryTest extends XacmlJsonTest
{
	/**
	 * test root directory location, where each subdirectories contains a category of tests
	 */
	private final static String TEST_RESOURCES_ROOT_DIRECTORY_LOCATION = "target/generated-test-resources/conformance/xacml-3.0-from-2.0-ct/mandatory/json";
